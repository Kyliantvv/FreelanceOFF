...
require('../../scss/Index/indexPresentation.scss');
...
$(document).ready(function() {
    ...
    function loadContent(mode){
        const contentPresentation = document.getElementById("contentPresentation");
        const freelance = contentPresentation.dataset.freelance;
        const enterprise = contentPresentation.dataset.enterprise;
        const url = Routing.generate('index_presentation_content.'+$('html')[0].lang, {'mode' : mode ? enterprise : freelance});
        ...
        $.ajax({
            ...
            url: url,
            success: function (data) {
                document.getElementById("contentPresentation").innerHTML = data;
            }
        });
    }
